...
public class HttpUtils {
    ...
    public static ApiHttpResponse reqForPost(String postUrl, String context, Integer timeout) {
        ApiHttpResponse res = new ApiHttpResponse();
    ...
    public static ApiHttpResponse reqForGet(String getUrl, Integer timeout) {
        ApiHttpResponse res = new ApiHttpResponse();
        Date sendTime = new Date();
        res.setSendTime(sendTime);
        try {
